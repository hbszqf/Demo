    ...
    for root, dirs, fils in os.walk(proto_dir):
        for fil in fils:
            try:
                ...
                cmd = "protoc.exe -I %s  --descriptor_set_out %s %s"%( proto_dir, out_path, in_path )
...
if __name__ == "__main__":
    ...
    protos_path = r"D:\MyHubDemo\Demo\Assets\Lua\Net\tmProto.lua"
    proto_dir = r"D:\pbcTest\proto\protos"
    proto_out_dir = r" D:\MyHubDemo\Demo\Assets\ResArt\DynamicArt\Protobuf"
